...
class ClassLoader
{
     ...
     *  admin\controllers\user => app/controllers/UserController.php
     *  other\views\user => app/views/UserView.php
     * ]
     * ```
     * 那么会有前缀加载路径
     * [
     ...
     * [
     * "yii\\": [
     *      "/var/www/html/yii2-framework-source-code/vendor/composer/../../framework"
     * ],
     * "helpers\\": [
     *      "/var/www/html/yii2-framework-source-code/vendor/composer/../../helpers"
     * ],
     * "app\\": [
     *      "/var/www/html/yii2-framework-source-code/vendor/composer/../../app"
     * ]
     * ```
     *
     * @var array
